...
export default function SearchServerSide(props) {
  const [searchResults, setSearchResults] = useState<object[]>(props.productData)
...
export const getServerSideProps: GetServerSideProps = async () => {
  const res = await fetch(`https://hatsa.com/api/search/public/afiproducts/search`)
  const { data } = await res.json()

  return { props: { productData: data }}
}
